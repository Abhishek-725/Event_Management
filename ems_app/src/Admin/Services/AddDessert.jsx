...
return ( <>
    ...
    <div className={style.mainContainer}>
        <div className={style.container}>
            <div className={style.addEventText}>ADD DESSERT</div>
                <form onSubmit={handleSubmit((data)=>{
                    console.log("Data : ",data);
                    let {desertName , desertPrice , description} = data;
                    // Send data to Server
                    axios
                        .post("http://localhost:3001/dessert/insertDessert", 
                        {
                            desertName,
                            description,
                            desertPrice,
                    ...
                    <div className={style.errorMsg}>
                        {errors.desertName && <span>*{errors.desertName.message}</span>}
                    </div>
                        <label>Dessert Name :</label>
                        <input style={{"marginLeft":"45px"}}
                        type="text" placeholder="Enter Dessert Name..." className={style.input}
                            {...register("desertName",{
                                required:{
                                    value:true,
                                    message:"Dessert is Required!"
                                },     
                                pattern: {
                    ...
                    <div className={style.eventName}>
                    <div className={style.errorMsg}>
                        {errors.desertPrice && <span>*{errors.desertPrice.message}</span>}
                    </div>
                        <label>Dessert Price :</label>
                        <input style={{"marginLeft":"50px"}}
                        type="text" placeholder="Enter Dessert Price..." className={style.input}
                            {...register("desertPrice",{
                                required:{
                                    value:true,
                                    message:"Dessert Price is Required!"
                                },     
                                pattern: {
                                    value: /^[1-9]+[0-9]/i,
                    ...
                    <div className={style.errorMsg}>
                        ...
                        <label className={style.labTxtArea}>Dessert Description :</label>
                        <textarea 
                    ...
                    <div className={style.eventImage}>
                        ...
                        <label style={{"marginRight":"35px"}}>Select Image :</label>
                            <input 
